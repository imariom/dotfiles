...
"
" Version 1.0.0 created at 03 December 2021 last updated 04 July 2022
...
call plug#begin('~/.vim/plugged')
    ...
    Plug 'xiyaowong/transparent.nvim'                    " Add transparency support
    ...
    Plug 'OmniSharp/omnisharp-vim'                       " Plugin for Vim to provide IDE like abilities for C#
...
" Configure the default OmniSharp-roslyn server to use 1-stdio and 0-HTTP
...
set background=dark               " Set editor background color to dark
colorscheme gruvbox            " Set text-editor theme to PaperColor theme
...
" Move a line or selection up and down
nnoremap <A-j> :m .+1<CR>==
nnoremap <A-k> :m .-2<CR>==
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
set guifont=SauceCodePro_Nerd_Font_Mono:12
